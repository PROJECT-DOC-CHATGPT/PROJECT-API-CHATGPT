    ...
    <>
      ...
      {generatedQuestions && (
        <div className="generated-content">
          ...
          <button onClick={generateDocument} className=' sombra letter-font position-block bottom-0 start-50 translate-middle-x generate btn btn-descargar btn-danger'>
            Descargar</button>
